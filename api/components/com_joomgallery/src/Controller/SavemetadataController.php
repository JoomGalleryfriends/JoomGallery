 ...
 * @since  4.0.0
 */
class SavemetadataController extends ApiController
{
    /**
     ...
     * @since  4.0.0
     */
    protected $contentType = 'savemetadata';
     ...
     * @since  3.0
     */
    protected $default_view = 'savemetadata';
...
//    }
    ...
    public function save_metadata($cachable = false, $urlparams = [])
    {
        // parent::displayItem();
