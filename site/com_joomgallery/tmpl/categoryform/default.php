...
<div class="jg category-edit front-end-edit item-page">
  ...
  <?php else : ?>
    <form id="adminForm"
          action="<?php echo Route::_('index.php?option=com_joomgallery&controller=categoryform&id='.$this->item->id); ?>"
      ...
      <fieldset>
        ...
        <input type="hidden" name="jform[checked_out]"
               value="<?php echo isset($this->item->checked_out) ? $this->item->checked_out : ''; ?>"/>
        ...
        <input type="hidden" name="jform[level]"
               value="<?php echo isset($this->item->level) ? $this->item->level : ''; ?>"/>
        <input type="hidden" name="jform[path]"
               value="<?php echo isset($this->item->path) ? $this->item->path : ''; ?>"/>
        <input type="hidden" name="jform[in_hidden]"
               value="<?php echo isset($this->item->in_hidden) ? $this->item->in_hidden : ''; ?>"/>
