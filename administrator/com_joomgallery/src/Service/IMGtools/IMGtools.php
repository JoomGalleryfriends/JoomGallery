...
abstract class IMGtools implements IMGtoolsInterface
{
  ...
  public function analyse($img, $is_stream = false)
  {
    ...
    $imagetype = [0=>'UNKNOWN', 1 => 'GIF', 2 => 'JPG', 3 => 'PNG', 4 => 'SWF',
  ...
  {
    $IFD_Data_Sizes = [1 => 1,         // Unsigned Byte
      2 => 1,         // ASCII String
      3 => 2,         // Unsigned Short
      4 => 4,         // Unsigned Long
