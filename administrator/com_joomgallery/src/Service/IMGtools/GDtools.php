...
class GDtools extends BaseIMGtools implements IMGtoolsInterface
{
   ...
   * @since   4.0.0
   */
  public function __construct($debugoutput, $keep_metadata=false, $keep_anim=false, $fastgd2thumbcreation = true)
  {
    parent::__construct($debugoutput, $keep_metadata, $keep_anim);
