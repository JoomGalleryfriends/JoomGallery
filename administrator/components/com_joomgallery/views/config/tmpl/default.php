...
JHTML::_('joomconfig.start', 'page21');
    ...
    $imgvaluereplacer[] = JHTML::_('select.option','99999', JText::_('COM_JOOMGALLERY_CONFIG_GS_TAB_BACKEND_REPLACEVALUES_EXIF') . '-' . $this->exif_config_array['COMMENT'][99999]['Name']); // File Comment
